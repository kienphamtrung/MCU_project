...
/**
  * @brief   BUZZER hardware config
  */
#define htim                    htim3
#define TIM_CHANNEL             TIM_CHANNEL_1
#define TIMER                   TIM3
#define	SET_FREQ(BUZZER_FREQ) 	(SystemCoreClock/(256*BUZZER_FREQ))
